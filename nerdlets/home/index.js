    ...
    return (
      <main id='cost-reduction-main'>
        <div style={{ padding: '15px' }}>
          ...
          <SearchComponent forceUpdate={this.state.forceUpdate} onChange={(value) => this.setState({ searchTerm: value })} />
        </div>
        <div id='cost-reduction-grid-main' style={{ padding: '10px' }}>
          <Tabs defaultValue="tab-3">
            <TabsItem className="tab-nr1-ageri" value="tab-1" label="Alertas">
              <AlertsComponents searchTerm={this.state.searchTerm} />
            </TabsItem>
            <TabsItem className="tab-nr1-ageri" value="tab-2" label="Dashboards">
              <DashboardComponents searchTerm={this.state.searchTerm} />
            </TabsItem>
          </Tabs>
        </div>
